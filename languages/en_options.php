...
$opStr[4] = 'Sets an optional prefix to table names';	//NEW FOR 2.0b5
$opStr[5] = 'The domain where Some Chess is located';
$opStr[6] = 'The language used in Some Chess';  //MODIFIED FOR 2.0b4
...
$opStr[20] = 'Email players after making moves';	//NEW FOR 2.0b4
